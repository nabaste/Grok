...
public class CTABuilder : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        DebugUIBuilder.instance.AddButton("Relive Experience", ReliveButtonPressed);
        DebugUIBuilder.instance.AddButton("Go to Menu", MenuButtonPressed);
